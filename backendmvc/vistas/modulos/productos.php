                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h1 style cen>Sistema Para Gestión De Actas</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                              ...
                              <div class="col-md-10">
                                <center><strong class="card-title">Tabla Actas</strong></center>
                              </div>
                            </div>
                            <div class="card-body">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <center><h5 class="modal-title" id="exampleModalLabel">Crear Nueva Acta</h5></center>
      </div>
       ...
       <form method="post">
        ...
        <div class="input-group mb-3">
          <select class="custom-select categoria " id="categoria" name="categoria">
            <option selected>Escoger programa</option>
                    <?php
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <center><h5 class="modal-title" id="exampleModalLabel">Editar Acta</h5></center>
      </div>
      <div class="modal-body">
       <form method="post">
        ...
        <div class="input-group mb-3">
          <select class="custom-select editarcategoria" id="iditarcategoria" name="editarcategoria">
            <option class="optioncategoria" id="optioncategoria">Seleccionar Programa</option>
